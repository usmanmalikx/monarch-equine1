            ...
            <div class="auto-container">
                <div class="sortable-masonry">
                    ...
                    <div class="items-container row clearfix">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all gourmet turist wedding">
                            <div class="gallery-block-two">
                                <div class="inner-box">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all product restaurant wedding">
                            <div class="gallery-block-two">
                                <div class="inner-box">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all gourmet finance turist">
                            <div class="gallery-block-two">
                                <div class="inner-box">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all business restaurant wedding">
                            <div class="gallery-block-two">
                                <div class="inner-box">
