...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- menu-section -->
        <section class="menu-section menu-page bg-color-1">
            <div class="pattern-layer">
        ...
        <section class="menu-style-four">
            <div class="auto-container">
                <div class="sec-title centred mb_90">
                    <span class="sub-title">Weekly Specials</span>
                    <h2>Menu Of The Day</h2>
                </div>
                    ...
                    <div class="menu-block-two">
                        <div class="inner-box">
                            <div class="shape">
                                <div class="shape-1" style="background-image: url(assets/images/shape/shape-3.png);"></div>
                                <div class="shape-2" style="background-image: url(assets/images/shape/shape-4.png);"></div>
                                <div class="shape-3" style="background-image: url(assets/images/shape/shape-27.png);"></div>
